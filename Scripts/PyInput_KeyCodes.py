...
#I don't think Syx uses keys the way it says... right clicking brings up the escape menu?
#The direction keys didnt seem to do anything? :|
...
def HoldAndReleaseKey2(hexKeyCode, hexKeyCode2, seconds):
    HoldKey(hexKeyCode)
    HoldKey(hexKeyCode2)
    time.sleep(seconds)
    ReleaseKey(hexKeyCode)
